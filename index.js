...
export function isColdAndHot(temp1, temp2) {
  const cold1 = temp1 < 0;
  const hot1 = temp1 > 100;
  const cold2 = temp2 < 0;
  const hot2 = temp2 > 100;
  return (cold1 && hot2) || (hot1 && cold2);
}
...
export function makeSLS(str1, str2) {
  const str1Shorter = str1.length < str2.length;
  const shortstr = str1Shorter ? str1 : str2;
  const longstr = str1Shorter ? str2 : str1;
